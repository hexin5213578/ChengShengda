...
public class StationDetailsBean {
    ...
    public static class ObjectBean {
        ...
        private List<StationOldInfoBean> stationOldInfo;
        ...
        public List<StationOldInfoBean> getStationOldInfo() {
            return stationOldInfo;
        }

        public void setStationOldInfo(List<StationOldInfoBean> stationOldInfo) {
            this.stationOldInfo = stationOldInfo;
        }
        ...
        public static class StationOldInfoBean {
            /**
             * id : null
             * stationNum : 2
             * stationMoney : 800
